...
COMMANDS_DESCRIPTION = {
    ...
    f"{COMMAND_PREFIX}картинка/аниме/anime": "Показывает рандомную аниме пикчу из нашей базы",
}
...
BASE_DIR = Path.cwd()
GENSHIN_CHARACTERS_JSON_DIR = BASE_DIR / "genshin" / "download" / "json_data"
...
TEST_DB = int(os.getenv("TEST_DB", "1"))
